...
Lots of textual overhead and the hardest part is maintaining it over the long term. Better would be a complete search engine description in the HEAD, where also the other meta information is stored.
