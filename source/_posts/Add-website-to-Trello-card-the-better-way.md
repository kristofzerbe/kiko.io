...
![Trello card by Android Share](card-via-share.png)
...
![Open Bookmarklet on Website to store in Android Chrome](open-bookmarklet.gif)
...
![Trello card by Bookmarklet](card-via-bookmarklet.png)
