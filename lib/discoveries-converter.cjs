...
//console.log(_templateFile);
 ...
 //console.log(_post);   
  ...
  convert() {
    ...
    let photosDir = path.join(_rootPath, _config.static_dir, _config.photo_dir);
    let staticDir = path.join(_rootPath, _config.static_dir, _config.reserve_dir);
    _post.photograph = getStaticPhotographInfo(staticDir, fm.hero, photosDir);
